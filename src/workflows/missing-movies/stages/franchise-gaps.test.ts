// franchise-gaps stage test (T468 — moved verbatim from
// src/workflows/movies/stages/franchise-gaps.test.ts when the job moved to this
// workflow) — hermetic: synthetic snapshot file + injected TMDB fetchers (NO
// live Plex/TMDB, scratch DB). Covers: collection fetches are DEDUPED (a
// collection with several owned members is fetched ONCE), released-not-owned
