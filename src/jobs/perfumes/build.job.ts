...
const job: JobDefinition = {
  ...
  instructions: 'Part of the perfumes workflow. Reads data/out/fragrantica/<id>.json → data/out/markdown/<id>.md, following perfume-markdown\'s _TEMPLATE.md. Idempotent by perfume id.',
  schedule: null,
  timeoutMs: 0,
  maxRetries: 0,
